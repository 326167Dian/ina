...
$pdf = new FPDF("P", "cm", array($tinggikertas, 8.5));
...
//HEADER 1
$pdf->Line(0, 2.6, 8.5, 2.6); //horisontal bawah

$pdf->Line(0, 4.8, 8.5, 4.8); //judul tabel atas
...
while ($r2 = mysqli_fetch_array($query)) {
	...
	$pdf->Cell(8, 0.4, $r2['nmbrg_dtrkasir'], 0, 1, 'L');
	$pdf->Cell(1.4, 0.4, ' ', 0, 0, 'R');
	$pdf->Cell(2.6, 0.4, $r2['qty_dtrkasir'].' '.$r2['sat_dtrkasir'], 0, 0, 'C');
