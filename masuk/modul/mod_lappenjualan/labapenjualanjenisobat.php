	  ...
	  ?>
			...
			<div class="box box-primary box-solid">
				<div class="box-header with-border">
					<h3 class="box-title">LAPORAN LABA PENJUALAN JENIS OBAT TERTENTU </h3>
				...
				<div class="box-body">
						...
						<form method="POST" action="modul/mod_laporan/tampil_labajenisobat.php" target="_blank" enctype="multipart/form-data" class="form-horizontal">
