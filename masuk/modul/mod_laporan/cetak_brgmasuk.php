...
$pdf->Cell(12.5, 0.7, 'Nama Barang', 1, 0, 'L');
...
//detail barang
$detailbrg=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM trbmasuk_detail WHERE trbmasuk_detail.kd_trbmasuk ='$kd_trbmasuk' ORDER BY trbmasuk_detail.id_dtrbmasuk ASC");
$no2=1;
while($lihat=mysqli_fetch_array($detailbrg)){

	$pdf->Cell(1, 0.5, $no2 , 1, 0, 'C');
	$pdf->Cell(4, 0.5, $lihat['kd_barang'],1, 0, 'L');
	$pdf->Cell(12.5, 0.5, $lihat['nmbrg_dtrbmasuk'], 1, 0,'L');
