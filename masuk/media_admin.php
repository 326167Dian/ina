			...
			<div class="wrapper">
				...
				<header class="main-header">
					...
					<a href="#" class="logo">
						...
						<span class="logo-mini"><b>APOTEK INA FARMA</b></span>

						<!-- logo for regular state and mobile devices -->
						<span class="logo-lg"><b>APOTEK INA FARMA</b></span>
					</a>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['stokopname'] == "Y") { ?><li><a href="?module=stokopname"><i class="glyphicon glyphicon-share"></i> Stok Opname </a></li><?php } ?>
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									...
									<?php if ($_SESSION['shiftkerja'] == "Y") { ?><li><a href="?module=shiftkerja"><i class="glyphicon glyphicon-level-up"></i> OPEN KASIR</a></li><?php } ?>
